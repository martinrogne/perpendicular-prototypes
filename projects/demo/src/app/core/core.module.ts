...
import { PRODUCTREGISTRY_CLEAR_ON_IDENTITY_CHANGE, PRIVACY_POLICY_COOKIE_PREFIX, AUTH_COOKIE_SESSION_ONLY, IDENTITY_SERVICE_FETCH_ENTITLED_ORGS, GUEST_LOGIN_MARKETING_CONSENT, AUTH_COOKIE_NAME,MARKETING_CONSENT_COOKIE_PREFIX } from 'perpendicular-core';
